			  ...
			  else if(exam_time=="wait")
			  {
				  if(diff>0 && diff<=600)
				  {
				     ...
				     "<?php 
						...
						echo '<br>'.'<br>'.'<center>'.'<b>'.'<h2>'."Times left: "." ".$d.":".$i.'</h2>'.'</b>'.'</center>'.'<br>'.'<br>'.'<br>'.'<br>';
				      ?>";
				  }
				  else
				  {
		...
		<div id="demo" >
		  ...
		  <table class="table table-bordered">
			...
			<?php if(isset($qust['ans1'])){?>
			  <tr class="info">
				<td>&nbsp;1&emsp;<input type="radio" value="0" name="<?php echo$qust['id'];?>"  onclick="scrollWin(0,300)"/>&nbsp;<?php echo$qust['ans1'];?></td>
			  </tr>
			  <?php }?>
			  <?php if(isset($qust['ans2'])){?>
			  <tr class="info">
				<td>&nbsp;2&emsp;<input type="radio" value="1" name="<?php echo$qust['id'];?>"  onclick="scrollWin(0,300)"/>&nbsp;<?php echo$qust['ans2'];?></td>
			  </tr>
			   <?php }?>
			  <?php if(isset($qust['ans3'])){?>
			  <tr class="info">
				<td>&nbsp;3&emsp;<input type="radio" value="2" name="<?php echo$qust['id'];?>"  onclick="scrollWin(0,300)"/>&nbsp;<?php echo$qust['ans3'];?></td>
			  </tr>
			   <?php }?>
			  <?php if(isset($qust['ans4'])){?>
			  <tr class="info">
				<td>&nbsp;4&emsp;<input type="radio" value="3" name="<?php echo$qust['id'];?>"  onclick="scrollWin(0,300)"/>&nbsp;<?php echo$qust['ans4'];?></td>
			  </tr>
			   <?php }?>
			    <tr class="info">
