...
<div class="container">   
  ...
  <div class="panel panel-default">
    ...
    <div class="panel-body"><h3>Online Quiz<sub> ..developed by <a href="mailto:nomanpc13@gmail">Noman and Borhan</a></sub></h3></div>
      ...
      <ul class="nav navbar-nav">
        ...
        <li class="dropdown">
          ...
          <ul class="dropdown-menu">
            ...
            <li><a data-toggle="tab" href="#menu4">Set up Exam Date</a></li>
		...
		<li class="dropdown">
          ...
          <ul class="dropdown-menu">
			...
			<li><a data-toggle="tab" href="#del_res">Delete Result</a></li>
            
          </ul>
        </li>
		<li><a data-toggle="tab" href="#pre_ques">Preview Question</a></li>
        <li><a data-toggle="tab" href="#result">Result</a></li>
         <li><a data-toggle="tab" href="#nomanp"><span class="glyphicon glyphicon-user"></span> privacy</a></li>
      </ul>
  ...
  <div class="carousel-inner" role="listbox">
    ...
    <h4>.<br>.<br><span style="font-style:normal;">Sir alwayes makes sure to review the question before any exam</span></h4>
    </div>
    <div class="item">
      <h4>.<br>.<br><span style="font-style:normal;">
	  Next immediate exam ->
	  <?php 
  ...
  <a class="right carousel-control" href="#myCarousel" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
		  ...
		  <div class="tab-content">   
			<div id="home" class="tab-pane fade in active">
			  <h3>Some rules to use this site:</h3>
			         <ul>
					     <li>When you delete a subject ,all record will be deleted related this subject</li>
						 <li>When you make a question you must have to set up exam time and date</li> 
						 <li>After making  questionnaire  you should review the questionnaire to avoid any question</li>
						 <li>After making  questionnaire  you must have to delete previous  result regarding to the question</li>
					 </ul>
    ...
    <div id="menu2" class="tab-pane fade">
	  ...
	  <div id="add_sub" class="tab-pane fade">
	   ...
	   <div id="nomanp" class="tab-pane fade">
	             
	              
				  
	  			  <div class="panel panel-default">
				    
						 <div class="panel-body"><h4>Change password</h4></div>
							<div class="panel-body">
								  ...
								  <form role="form" action="change_pass.php" method="post" >
									...
									<div class="form-group">
									  ...
									  <input type="password" class="form-control" name="p" id="opwd" placeholder="Enter password" required>
									</div>
									<div class="form-group">
									  <label for="pwd">New Password:</label>
									  <input type="password" class="form-control" name="p" id="npwd" placeholder="Enter password" required>
									</div>
     ...
     <div id="del_res" class="tab-pane fade">
	  
	     <br>
		 <br>
			<center><button type="button" class="btn btn-info" data-toggle="tab" href="#select105">Select Subject</button></center> 
      
	  
	           <div class="col-sm-4"></div>
	           <div class="col-sm-4"><br>
		         <div id="select105" class="tab-pane fade">
		    
		          <form method="post" onsubmit="return confirm('Do you really want to delete?');"  action="del_res.php">
				  <select class="form-control" id="" name="cat">
